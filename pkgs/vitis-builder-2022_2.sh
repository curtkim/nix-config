...
patchShebangs $out/opt/Vitis/2022.2/bin
echo "Shebangs patched"

# Hack around lack of libtinfo in NixOS
ln -s $ncurses/lib/libncursesw.so.6 $out/opt/Vitis/2022.2/lib/lnx64.o/libtinfo.so.5

# Patch ELFs
for f in $out/opt/Vitis/2022.2/bin/unwrapped/lnx64.o/*
do
...
wrapProgram $out/opt/Vitis/2022.2/bin/vitis --prefix LD_LIBRARY_PATH : "$libPath"
...
mkdir $out/bin
ln -s $out/opt/Vitis/2022.2/bin/vitis $out/bin/vitis
